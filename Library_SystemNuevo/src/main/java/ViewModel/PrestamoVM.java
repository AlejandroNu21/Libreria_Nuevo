...
public class PrestamoVM {
    ...
    private prestamoType Devuelto;

    public PrestamoVM(int idPrestamo, String Nombre_Lector, String Titulo, Date Fecha_Prestamo, Date Fecha_Devolucion, prestamoType Devuelto) {
